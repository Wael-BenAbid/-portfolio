...
class VisitorTrackingMiddleware(MiddlewareMixin):
    ...
    def process_response(self, request, response):
        """
        Track visitor information when response is returned
        """
        ...
        try:
            ...
            # Session key can be None if session middleware hasn't created one yet
            ...
            Visitor.objects.create(
                ...
                is_unique=self.is_unique_visitor(ip_address, session_key),
